...
[![Version](https://img.shields.io/badge/Version-0.1%20(dev)-FF1A8C.svg)](https://github.com/MikalaiKryvusha/KRINIK-S-ANDROID-USB-WEB-CAMERA-FOR-STREAMING/releases)
...
> **Status:** Active development · Phase 1 in progress (USB preview + YouTube stream)
...
| RTMP stream to YouTube | 🔨 Phase 1 |
| Simultaneous multi-platform streaming | 📅 Phase 2 |
| Hardware H.264 / HEVC / AV1 encoding | 📅 Phase 2 |
...
## Quick Start (when v0.2 is released)
...
> **Статус:** Активная разработка · Phase 1 в процессе (USB превью + YouTube стрим)
...
| RTMP-стрим на YouTube | 🔨 Phase 1 |
| Одновременный стрим на несколько платформ | 📅 Phase 2 |
| Аппаратное кодирование H.264 / HEVC / AV1 | 📅 Phase 2 |
...
## Быстрый старт (после выхода v0.2)
